 ...
 */
function aromatic_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function aromatic_sanitize_html( $html ) {
 ...
 */
function aromatic_sanitize_number_absint( $number, $setting ) {
 ...
 */
function aromatic_sanitize_select( $input, $setting ) {
 ...
 */
function aromatic_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function aromatic_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function aromatic_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}