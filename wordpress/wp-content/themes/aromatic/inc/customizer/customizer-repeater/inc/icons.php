    ...
    <div class="popover-content">
        <div class="iconpicker">
            <div class="iconpicker-items">
				<i data-type="iconpicker-item" title=".ja-wishlist" class="jcs ja-wishlist"></i>
				<i data-type="iconpicker-item" title=".ja-wishlist-2" class="jcs ja-wishlist-2"></i>
				<i data-type="iconpicker-item" title=".ja-wishlist-3" class="jcs ja-wishlist-3"></i>
				<i data-type="iconpicker-item" title=".ja-wishlist-4" class="jcs ja-wishlist-4"></i>
				<i data-type="iconpicker-item" title=".ja-support" class="jcs ja-support"></i>
				<i data-type="iconpicker-item" title=".ja-cart" class="jcs ja-cart"></i>
				<i data-type="iconpicker-item" title=".ja-clock" class="jcs ja-clock"></i>
				<i data-type="iconpicker-item" title=".ja-compare" class="jcs ja-compare"></i>
				<i data-type="iconpicker-item" title=".ja-customer-support" class="jcs ja-customer-support"></i>
				<i data-type="iconpicker-item" title=".ja-delivery" class="jcs ja-delivery"></i>
				<i data-type="iconpicker-item" title=".ja-document" class="jcs ja-document"></i>
				<i data-type="iconpicker-item" title=".ja-eye" class="jcs ja-eye"></i>
				<i data-type="iconpicker-item" title=".ja-location" class="jcs ja-location"></i>
				<i data-type="iconpicker-item" title=".ja-mail" class="jcs ja-mail"></i>
				<i data-type="iconpicker-item" title=".ja-search" class="jcs ja-search"></i>
				<i data-type="iconpicker-item" title=".ja-secure-payment" class="jcs ja-secure-payment"></i>
