...
(function ($) {
  "use strict";
	...
	$(document).ready(function() {
		...
		$(".klb-image-demo-select .klb-demo-item:first-child img").addClass('active');

		$(document).on('click', '.klb-image-demo-select img', function(event){
			$('.klb-image-demo-select img').removeClass('active');
			$(this).addClass('active');
			$("select.merlin__select-control").val($(this).attr('value'));
		});
	});
